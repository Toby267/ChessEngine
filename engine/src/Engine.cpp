...
Engine::Engine() {    
    for (int i = 1; i <= 15; i++) {
        ...
        // parseFen("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0");        //position 2                    - bug at depth 5, should be: 193690690, is: 193690689,  of by: -1
        parseFen("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 1");                                   //position 3                    - bug at depth 5, should be: 674624,    is: 674622,     of by: -2
        // parseFen("r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1");            //position 4                    - bug at depth 5, should be: 15833292,  is: 15833240,   of by: -52
            // parseFen("r2q1rk1/pP1p2pp/Q4n2/bbp1p3/Np6/1B3NBn/pPPP1PPP/R3K2R b KQ - 0 1 ");       //alternate to position 4       - bug at depth 5, should be: 15833292,  is: 15833240,   of by: -52
    ...
    // parseFen("8/8/8/6k1/5Pp1/8/8/3K2R1 b - f3 0 2");
